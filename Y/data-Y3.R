...
dat_Y3.load <- function(geno_table=Y_marker_st$marker,pheno_table="Y3.txt" ){
  dat_Y3<-list(TIME=NULL,
               geno=NULL,
               pheno=NULL,
               trait=1)
  ...
  B_F<-read.table("Y3.txt",header=TRUE)
  B_F<-as.matrix(B_F)
  A1_F<-A_F[,1]
  B1_F<-B_F[,1]
  ...
  dat_Y3$geno <- AA1_F.1
  dat_Y3$pheno <- BB1_F.1
  return(dat_Y3)
}
dat_Y3_st <- dat_Y3.load(geno_table=Y_marker_st$marker,pheno_table="Y3.txt")
...
LR_length <-LR_value_ML(1,dat_Y3_st$geno,dat_Y3_st$pheno)
LR_daimeter<-LR_value_ML(2,dat_Y3_st$geno,dat_Y3_st$pheno)
...
LR_length_permu2 <-LR_ML_permu(1,dat_Y3_st$geno,dat_Y3_st$pheno,geno_type_st$marker2)# 6.510982
LR_length_permu3 <-LR_ML_permu(1,dat_Y3_st$geno,dat_Y3_st$pheno,geno_type_st$marker3)# 6.000698


plot(LR_daimeter[geno_type_st$marker2])
plot(LR_daimeter[geno_type_st$marker3])
LR_daimeter_permu2 <-LR_ML_permu(2,dat_Y3_st$geno,dat_Y3_st$pheno,geno_type_st$marker2) # 6.568583
LR_daimeter_permu3 <-LR_ML_permu(2,dat_Y3_st$geno,dat_Y3_st$pheno,geno_type_st$marker3)#5.546653
