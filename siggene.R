...
signum_anno_1<-function(LR_calyx,a,b){
  marker_table <-  F_marker_st$marker[-1,1:2]
...
marker_name_anno_1<-function(LR_calyx,a,b){
  marker_table2 <- F_marker_st$marker[-1,1:2]
...
gene_anno_colour<-gene_name_anno_1(LR_colour,a=10.768008,b=7.654453)
gene_anno_bud<-gene_name_anno_1(LR_bud,a=5.634593,b=5.248507)
gene_anno_shape<-gene_name_anno_1(LR_shape,7.040742,5.254234)
gene_anno_period<-gene_name_anno_1(LR_period,a=6.878382,b=6.168139)
gene_anno_pistils<-gene_name_anno_1(LR_pistils,a=14.983331,b=10.665697)
gene_anno_size<-gene_name_anno_1(LR_size,7.931283,7.334037)
gene_anno_petals<-gene_name_anno_1(LR_petals,a=12.227272,b=7.612247)
gene_anno_pedicels<-gene_name_anno_1(LR_pedicels,6.575807,6.402251)
gene_anno_length<-gene_name_anno_1(LR_length,a=9.858573,b=11.959839)
gene_anno_daimeter<-gene_name_anno_1(LR_daimeter,a=7.488185 ,b=8.263014)


write.csv(gene_anno_colour,file="2020-1/siggene/L-colour.csv",row.names = FALSE)
write.csv(gene_anno_bud,file="2020-1/siggene/L-bud.csv",row.names = FALSE)
write.csv(gene_anno_shape,file="2020-1/siggene/L-shape.csv",row.names = FALSE)
write.csv(gene_anno_period,file="2020-1/siggene/L-period.csv",row.names = FALSE)
write.csv(gene_anno_pistils,file="2020-1/siggene/L-pistils.csv",row.names = FALSE)
write.csv(gene_anno_size,file="2020-1/siggene/L-size.csv",row.names = FALSE)
write.csv(gene_anno_petals,file="2020-1/siggene/L-petals.csv",row.names = FALSE)
write.csv(gene_anno_pedicels,file="2020-1/siggene/L-pedicels.csv",row.names = FALSE)
write.csv(gene_anno_length,file="2020-1/siggene/L-length.csv",row.names = FALSE)
write.csv(gene_anno_daimeter,file="2020-1/siggene/L-daimeter.csv",row.names = FALSE)
