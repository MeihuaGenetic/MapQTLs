...
LR_pistils <-LR_value_ML(1,dat_L2_st$geno,dat_L2_st$pheno)
LR_size <-LR_value_ML(2,dat_L2_st$geno,dat_L2_st$pheno)
LR_pedicels <-LR_value_ML(4,dat_L2_st$geno,dat_L2_st$pheno)
...
LR_size_permu2 <-LR_ML_permu(2,dat_L2_st$geno,dat_L2_st$pheno,geno_type_st$marker2)#
LR_size_permu3 <-LR_ML_permu(2,dat_L2_st$geno,dat_L2_st$pheno,geno_type_st$marker3)#


plot(LR_pedicels[geno_type_st$marker2])
plot(LR_pedicels[geno_type_st$marker3])
LR_pedicels_permu2 <-LR_ML_permu(4,dat_L2_st$geno,dat_L2_st$pheno,geno_type_st$marker2) #
LR_pedicels_permu3 <-LR_ML_permu(4,dat_L2_st$geno,dat_L2_st$pheno,geno_type_st$marker3)#
